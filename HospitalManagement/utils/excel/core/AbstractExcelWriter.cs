...
namespace HospitalManagement.utils.excel.core
{
    ...
    public abstract class AbstractExcelWriter<T> : IExcelSheetWriter<T>
    {
        ...
        /// </summary>
        protected void SetCell(ExcelWorksheet worksheet, int row, int col, object? value, ExcelStyle style)
        {
        ...
        /// </summary>
        protected void ApplyStyle(ExcelRange cell, ExcelStyle style)
        {
